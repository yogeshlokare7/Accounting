    ...
    <div class="col-sm-12">
        <script>
            init.push(function () {
                ...
                $('#jq-datatables-example_wrapper .table-caption').text('Type Master Information');
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <span class="panel-title">
                    <button class="btn btn-success btn-xs btn-outline btn-flat btn-rounded" data-toggle="modal" data-target="#myModal">Add Type Master</button>
                </span>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add Type Master Information</h4>
            </div>
