    ...
    <div class="col-sm-12">
        <script>
            init.push(function () {
                ...
                $('#jq-datatables-example_wrapper .table-caption').text('Subtrader Master Information');
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <span class="panel-title">
                    <button class="btn btn-success btn-xs btn-outline btn-flat btn-rounded" data-toggle="modal" data-target="#myModal">Add Subtrade Master  </button>
                </span>
            </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Subtrader Id</th>
                                <th>Subtrader Name</th>
                                <th>Subtrader Email</th>
                                <th>Address</th>
                                <th>Country</th>
                                <th>Province</th>
                                <th>Contact No</th>
                        ...
                        <tbody>
                            ...
                            foreach ($resultset as $key => $value) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $value["subtrader_email"] ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add Subtrader Information</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
                                <label class="control-label">Subtrader Name *</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
                                ...
                                <input type="text" name="subtrader_email" required="true" autofocus="" placeholder="Enter Data Here" class="form-control">
                            </div>
                        </div><!-- col-sm-6 -->
                        <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
                                ...
                                <input type="text" name="contact_person_name" autofocus="" placeholder="Enter Fax number" class="form-control">
                            </div>
                        </div><!-- col-sm-6 -->
                            <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
                                <label class="control-label">Contact Person Phone *</label>
                                <input type="text" name="contact_person_phone" autofocus="" placeholder="Enter Contact" class="form-control">
                            </div>
                        </div><!-- col-sm-6 -->
                        <div class="col-sm-6">
                            <div class="form-group no-margin-hr">
