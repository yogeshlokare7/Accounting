    ...
    <div class="col-sm-12">
        <script>
            init.push(function () {
                ...
                $('#jq-datatables-example_wrapper .table-caption').text('Virtual Checkbox LP Account Information');
        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <span class="panel-title">
                    <button class="btn btn-success btn-xs btn-outline btn-flat btn-rounded" data-toggle="modal" data-target="#myModal">Add Virtual Checkbox LP Account</button>
                </span>
            </div>
